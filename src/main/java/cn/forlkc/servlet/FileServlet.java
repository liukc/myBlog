...
import cn.forlkc.tools.Result;
import cn.forlkc.tools.ResultUtil;


public class FileServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String savePath = this.getServletContext().getRealPath("/upload/blog");
        ...
        try{
            ...
            for(FileItem item : list) {
                 ...
                 */
                String str = request.getContextPath() + "/upload/blog/" + filename;
                JSONObject json = new JSONObject();
                //json.put("name","img");
                json.put("imgUrl",str);
                response.getWriter().write(json.toString());//返回url地址
